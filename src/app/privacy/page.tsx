    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <div className="prose prose-lg dark:prose-invert max-w-4xl mx-auto">
        ...
        <p>
          ...
          whenever you visit our site. This may include your computer's Internet Protocol (IP)
          address, browser type and version, the pages you visit on our site, the time and date of
        ...
        <p>
          ...
          information may include, but is not limited to, your email address and name ("Personal
          Information").
        </p>
        <h2>Security</h2>
        <p>
        ...
        <p>
          This Privacy Policy is effective as of today and will remain in effect except with respect
